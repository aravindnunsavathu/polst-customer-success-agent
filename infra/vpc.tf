...
# trade-off at this stage (mirrors "Multi-AZ off" on RDS). Revisit if a
# single-AZ outage taking down egress for the whole app becomes a real risk.
...
# --- Security groups ---
# ALB accepts from the internet; ECS accepts only from the ALB; RDS accepts
# only from ECS. No security group is ever opened directly to 0.0.0.0/0
# except the ALB's public listener port, per §14.
